  ...
  const educationData = [
    {
      ...
      period: "2019 - 2023",
      description:
        "Comprehensive program covering computer science fundamentals, software development, and engineering practices.",
      achievements: [
        "Completed major projects in software development",
        "Participated in coding competitions and hackathons",
        "Learned modern software development practices",
      ],
      courses: [
        "Algorithms",
        "System Design",
    ...
    {
      id: "cert1",
      degree: "Computer System Security",
      institution: "E & ICT Academy, Indian Institute of Technology, Kanpur",
      location: "Kanpur, India",
      period: "March 2021",
      description:
        "Specialized certification in computer system security covering fundamental security concepts and practices.",
      achievements: [
        "Mastered system security fundamentals",
        "Completed hands-on security projects",
      ...
      rating: 4,
      skills: ["System Security", "Network Security", "Security Analysis"],
    },
    {
      id: "cert2",
      degree: "Cloud Core",
      ...
      description:
        "Foundational certification in cloud computing covering IBM Cloud services and architecture.",
      achievements: [
        "Mastered IBM Cloud fundamentals",
        "Completed hands-on cloud projects",
      ...
      rating: 4,
      skills: ["Cloud Computing", "IBM Cloud", "Cloud Architecture"],
    },
  ];
